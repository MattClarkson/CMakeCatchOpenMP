...
int main(int argc, char** argv)
{
  ...
  try
  {
    ...
    std::cout << "Calculating ... " << mjc::MyFirstAddFunction(1, 2) << std::endl;

    returnStatus = EXIT_SUCCESS;
  }
  catch (mjc::Exception& e)
  {
    std::cerr << "Caught mjc::Exception: " << e.GetDescription() << std::endl;
  }
